/**
 * This classe supports writing test and colours the output. Provided methods
 * have the same name as JUnit to facilitate using both.
 */
public class MyTestSupport {
    ...
    protected void assertNotNull(Object value, String msg) {
        if (value!= null)
            System.out.print(OK);
        else
            System.out.print(FAIL);
